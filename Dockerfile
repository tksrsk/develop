...
RUN npm install -g npm neovim typescript javascript-typescript-langserver typescript-language-server intelephense vscode-html-languageserver-bin vscode-css-languageserver-bin vim-language-server
